...
export const Home: React.FC = () => {
  ...
  // Read ?q= from URL (supports links from landing page)
  useEffect(() => {
    ...
    <div className={styles.page}>
      ...
      <div className={styles.ctaOuter}>
        <div className={styles.ctaInner}>
          ...
          <p className={styles.ctaDesc}>Join thousands of Nigerian buyers who verify vendors before every purchase.</p>
